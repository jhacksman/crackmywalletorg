...
def generate_passphrases(output_file="this_period_pass.txt"):
...
if __name__ == "__main__":
    print("Analyzing combinations with periods between words...")
